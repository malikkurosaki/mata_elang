...
export default function Sidebar(props) {
    ...
    return (
        <div className={
            classNames('sidebar d-flex flex-column position-fixed h-100', {
        ...
        >
          ...
          <use xlinkHref="/assets/brand/coreui.svg#signet" />
            ...
            <Button variant="link" className="sidebar-toggler d-none d-md-inline-block rounded-0 text-end pe-4 fw-bold shadow-none"
                onClick={toggleIsNarrow}
                type="button"
                aria-label="sidebar toggler">
                <FontAwesomeIcon className="sidebar-toggler-chevron"
                    icon={faAngleLeft}
                    fontSize={24} />
            </Button>
        </div>
